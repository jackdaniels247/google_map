...
class _SearchScreenState extends State<SearchScreen> {
  TextEditingController originTextEditingController=TextEditingController();
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Origin",style: TextStyle(fontSize: 18.0,fontFamily: "Brand-Bold"),),
                      )
                    ],
                  ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              controller: originTextEditingController,
...
class PredictionTile extends StatelessWidget {
  ...
  void getPlaceAddressDetails(String placeId,context) async{
    ...
    if(res["status"] == "OK"){
      ...
      Provider.of<AppData>(context,listen: false).updateOriginLocationAddress(address);
      print("This is Origin Location ::-------------------------------------------------------------------------------------------------------------------");
